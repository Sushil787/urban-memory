...
{ randomize();
  settextstyle(8,0,4);
  setcolor(1+random(14));
  outtextxy(200,100,"Election for New PM");
  delay(800);
  setcolor(1+random(14));
  outtextxy(250,160,"CSIT- Project");
  delay(800);
  setcolor(1+random(14));
...
{   setcolor(6);
    ...
    outtextxy(50,400,"By sushil gyawali ");
}
void showmouseptr()
{
i.x.ax=1;
...
void graph(int candidate1, int candidate2, int candidate3, int candidate4, int candidate5)
{   outtextxy(200,100,"RESULTS in Bar Graphs");
    candidate1=((vote1*100)/(vote1+vote2+vote3+vote4+vote5));
    candidate2=((vote2*100)/(vote1+vote2+vote3+vote4+vote5));
    candidate3=((vote3*100)/(vote1+vote2+vote3+vote4+vote5));
    candidate4=((vote4*100)/(vote1+vote2+vote3+vote4+vote5));
    candidate5=((vote5*100)/(vote1+vote2+vote3+vote4+vote5));
    setcolor(2);
    rectangle(100,300,130,300-candidate1);outtextxy(100,300,"sushil");
    rectangle(200,300,230,300-candidate2);outtextxy(200,300,"King");
    rectangle(300,300,330,300-candidate3);outtextxy(300,300,"K.P");
    rectangle(400,300,430,300-candidate4);outtextxy(400,300,"Deuba");
    rectangle(500,300,530,300-candidate5);outtextxy(500,300,"prachand");
